----------------------------- MODULE Spec2 -----------------------------
(***************Swethasri Kavuri (111465291)************************)
EXTENDS Naturals, Sequences

CONSTANT NumNats, NumProcs, _ \ll _
Proc == 1 .. NumProcs
Nats == 0 .. NumNats

ASSUME \A p \in Proc : /\ ~ (p \ll p)
...
ClockConstraint == \A p \in Proc : clock[p] < NumNats

Mutex ==
  \A s,t \in Proc : state[s] = "crit" /\ state[t] = "crit" => s = t
=============================================================================
